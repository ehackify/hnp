...
def main():
    cfg = dict(
        ...
        IDENT='collector',
        RHOST='hnpbroker.threatstream.com',
        RPORT=10000,
        RCHANNEL='hnp-community-v2.events',
        RIDENT='hnp-server',
        RSECRET='hnp-secret',
    ...
    try:
        ip = requests.get('https://myip.threatstream.com', headers={'User-Agent': 'hnp-collector-v2'}).text.strip()
    except:
        ip = None
    hnp_uuid = cfg['hnp_UUID']
