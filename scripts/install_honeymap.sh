...
cd /opt/
mkdir GeoLite2-City
wget https://github.com/ehackify/geolite2/raw/master/GeoLite2-City.tar.gz -O GeoLite2-City.tar.gz 
tar xvf GeoLite2-City.tar.gz -C GeoLite2-City --strip-components 1
mv GeoLite2-City/GeoLite2-City.mmdb ./
mkdir GeoLite2-ASN
wget https://github.com/ehackify/geolite2/raw/master/GeoLite2-ASN.tar.gz -O GeoLite2-ASN.tar.gz 
