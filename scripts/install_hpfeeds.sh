...
cd /tmp
wget https://github.com/ehackify/hpfeeds/releases/download/libev-4.15/libev-4.15.tar.gz
...
cd /opt
rm -rf /opt/hpfeeds
git clone https://github.com/ehackify/hpfeeds
chmod 755 -R hpfeeds
cd hpfeeds
...
pip install -e git+https://github.com/ehackify/evnet.git#egg=evnet-dev
pip install .
deactivate
