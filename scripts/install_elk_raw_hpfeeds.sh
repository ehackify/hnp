...
stdout_logfile=/var/log/hnp/kibana.log
stderr_logfile=/var/log/hnp/kibana.err
autostart=true
autorestart=true
startsecs=10
EOF
...
cat > /opt/logstash/hnp-hpfeeds.conf <<EOF
...
command=/opt/logstash/bin/logstash -f hnp-hpfeeds.conf
directory=/opt/logstash/
stdout_logfile=/var/log/hnp/logstash-hpfeeds.log
stderr_logfile=/var/log/hnp/logstash-hpfeeds.err
autostart=true
autorestart=true
startsecs=10
EOF
